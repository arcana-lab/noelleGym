...
extern "C" {
  ...
  DispatcherInfo NOELLE_HELIX_dispatcher_sequentialSegments (
    ...
    return NOELLE_HELIX_dispatcher(parallelizedLoop, env, loopCarriedArray, 2, numOfsequentialSegments, true);
  }
  ...
  DispatcherInfo NOELLE_HELIX_dispatcher_criticalSections (
    ...
    return NOELLE_HELIX_dispatcher(parallelizedLoop, env, loopCarriedArray, 2, numOfsequentialSegments, false);
  }
